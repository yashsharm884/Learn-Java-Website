...
<head>
	...
	<title>Contact-Learn Java</title>
...
<div class="title1">
	...
	<h2><br><br>We will Contact you<br><br></h2>
</div>
...
<div class="box">
	<form method="POST" action="insert.php">
		...
		<input type="text" name="mobile" class="form-control" placeholder="Enter the mobile number..." required><br>
		<input type="email" name="email" class="form-control" placeholder="Enter the email address..." required><br>

		<!--
		<textarea type="message" name="submit" class="form-control" value="Send Message" rows="4" placeholder="Type the message" 
		required></textarea><br>

	-->
		<input type="submit" name="submit" class="form-control submit">
	</form>
</div>



<p class="para_123" align="center" style="color: white">
<?php
